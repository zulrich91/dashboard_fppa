...
# print(player_attack_df.columns)
...
defense_cols = ['_id', 'Joueur', 'Club', 'Annees', 'Erreurs defensives', 'Tirs bloqués',
       'Tackles', 'Pressions', 'Balles recuperees']
player_defense_df.columns = defense_cols  

print(player_defense_df.columns)
